...
function display_warning(){
  ...
  warningHtml += "You are using an out-dated version of Internet Explorer, <a style='"+css_a+"' target='_blank' href='http://www.microsoft.com/windows/downloads/ie/getitnow.mspx'>download the latest version</a> for the best possibly viewing experience. Better yet, use <a style='"+css_a+"' target='_blank' href='http://www.mozilla.com/firefox/'>Firefox</a>, <a style='"+css_a+"' target='_blank' href='http://www.google.com/chrome'>Chrome</a> or <a style='"+css_a+"' target='_blank' href='http://www.apple.com/safari/'>Safari</a>.";
  warningHtml += "</div>";
  warningHtml += "</div>";
  var spacerHTML = "";
