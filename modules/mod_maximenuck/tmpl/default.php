            ...
            <ul class="menu<?php echo $params->get('moduleclass_sfx'); ?> maximenuck" style="<?php echo $menubgcolor; ?>">
				...
				foreach ($items as $i => &$item) {
					...
					if ($item->deeper) {
						...
						echo "\n\t<div class=\"floatck\" " . $item->styles . ">" . $close . "<div class=\"maxidrop-top\"><div class=\"maxidrop-top2\"></div></div><div class=\"maxidrop-main\"><div class=\"maxidrop-main2\"><div class=\"maximenuck2 first \" " . $nextcolumnstyles . ">\n\t<ul class=\"maximenuck2\">";
