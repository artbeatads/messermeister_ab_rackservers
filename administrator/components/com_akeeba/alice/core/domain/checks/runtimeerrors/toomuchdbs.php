...
class AliceCoreDomainChecksRuntimeerrorsToomuchdbs extends AliceCoreDomainChecksAbstract
{
    ...
    {
        parent::__construct(40, JText::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS'), $logFile);
    }
	...
	public function check()
	{
		...
		if(count($ex_tables))
		{
			...
			throw new Exception(JText::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS_ERROR'));
		}
	...
	{
		return JText::_('ALICE_ANALYZE_RUNTIME_ERRORS_TOOMUCHDBS_SOLUTION');
	}
}
