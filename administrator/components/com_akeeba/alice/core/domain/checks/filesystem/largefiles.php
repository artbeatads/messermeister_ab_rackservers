...
class AliceCoreDomainChecksFilesystemLargefiles extends AliceCoreDomainChecksAbstract
{
    ...
    {
        parent::__construct(10, JText::_('ALICE_ANALYZE_FILESYSTEM_LARGE_FILES'), $logFile);
    }
	...
	public function check()
	{
        ...
        if($badfiles)
        {
            ...
            throw new Exception(JText::sprintf('ALICE_ANALIZE_FILESYSTEM_LARGE_FILES_ERROR', '<br/>'.implode('<br/>', $errorMsg)));
        }
	...
	{
		return JText::_('ALICE_ANALIZE_FILESYSTEM_LARGE_FILES_SOLUTION');
	}
}
